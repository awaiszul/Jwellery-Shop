"use client";
import { products, categories, assets } from "@/assets/assets";
...
export default function FeaturedProducts() {
  ...
  return (
    <section className="w-[90%] mx-auto my-12">
      {/* Heading */}
      <h2 className="text-3xl md:text-4xl font-ovo font-bold mb-6 text-center relative w-fit mx-auto">
        Featured Products
      </h2>
            ...
            >
              ...
              <div className="flex flex-col flex-1 justify-between mt-3">
                ...
                <div
                  onClick={() => {
                    addToCart(product);
                    // 👈 Add to cart karne ke baad cart page open
                  }}
                ...
                >
                  ...
                  {/* <button className="bg-yellow-600 text-white px-4 py-2 rounded text-sm font-medium hover:bg-yellow-500">
                  Buy Now
                </button> */}
                </div>
              </div>
